...
/* Created 2022/12/23 22:48:45 bahram $ */
#include "../S_source.hh"
...
int PaperAirplaneSimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 0:
            paperPlane.default_data() ;
            break ;
        case 1:
            paperPlane.initial_data() ;
            break ;
        case 2:
            paperPlane.airplane_deriv() ;
            break ;
        case 3:
...
double PaperAirplaneSimObject::call_function_double ( Trick::JobData * curr_job ) {
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 19.6.0-beta, Fri Dec 23 22:48:45 2022" ) ;
    exec_set_build_date( "Fri Dec 23 22:48:45 2022" ) ;
    ...
    TMM_declare_ext_var(&dyn, TRICK_STRUCTURED,"PaperAirplaneSimObject", 0, "dyn", 0, NULL) ;
