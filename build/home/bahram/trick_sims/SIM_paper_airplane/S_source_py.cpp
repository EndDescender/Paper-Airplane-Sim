...
#define SWIGTYPE_p_Airplane swig_types[5]
#define SWIGTYPE_p_BC_INFO swig_types[6]
#define SWIGTYPE_p_CheckPointRestartSimObject swig_types[7]
#define SWIGTYPE_p_CommandLineArgumentsSimObject swig_types[8]
...
#define SWIGTYPE_p_PaperAirplaneSimObject swig_types[32]
...
/*-----------------------------------------------
              @(target):= _m6df225a75723545a06d7f08324795258.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m6df225a75723545a06d7f08324795258

#else
#  define SWIG_init    init_m6df225a75723545a06d7f08324795258

#endif
#define SWIG_name    "_m6df225a75723545a06d7f08324795258"
...
SWIGINTERN PyObject *PaperAirplaneSimObject___getitem__(PaperAirplaneSimObject *self,int ii){
        ...
        //std::cout << "HERE in class __getitem__!!!" << std::endl ;
        resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(&self[ii]), SWIG_TypeQuery("PaperAirplaneSimObject *"), 0);
        return(resultobj) ;
    }
SWIGINTERN PyObject *PaperAirplaneSimObject___len__(PaperAirplaneSimObject *self){
        // get_size only works if "self" was an allocated pointer
        return PyInt_FromLong(get_size((char *)self)) ;
    }
...
/* castAs##PaperAirplaneSimObject casts incoming ptrs as the target type.  Takes incoming object and tests if it
   is a compatible type, a void *, or an integer (raw pointer value).  If it is any of these
   types it returns the incoming value as a pointer to the outgoing type.  The integer
   conversion is used by the input processor to associate named allocations in the
   memory manager to names in pyton space.
 */
PaperAirplaneSimObject * castAsPaperAirplaneSimObject( PyObject * obj1 ) {
    void *argp = NULL ;
    PaperAirplaneSimObject * ret = (PaperAirplaneSimObject *)NULL ;

    //std::cout << "calling __cast_as" << std::endl ;
    if ( SWIG_IsOK(SWIG_ConvertPtr(obj1,&argp,SWIG_TypeQuery("PaperAirplaneSimObject *"),SWIG_POINTER_DISOWN)) ) {
        //std::cout << "we can cast to PaperAirplaneSimObject! " << argp << std::endl ;
        ret = reinterpret_cast< PaperAirplaneSimObject *>(argp) ;
    } else if (SWIG_IsOK(SWIG_ConvertPtr(obj1, &argp,SWIG_TypeQuery("void *"), 0 ))) {
        //std::cout << "we can cast (wrapped void *) to PaperAirplaneSimObject! " << argp << std::endl ;
        ret = reinterpret_cast< PaperAirplaneSimObject *>(argp) ;
    } else if ( PyInt_Check(obj1) ) {
        ret = reinterpret_cast< PaperAirplaneSimObject *>( PyInt_AsLong(obj1) ) ;
        //std::cout << "we are using incoming value as address " << PyInt_AsLong(obj1) << std::endl ;
    } else {
        std::cout << "Cast to PaperAirplaneSimObject failed." << std::endl ;
    }
    return ret ;
}
...
SWIGINTERN PyObject *_wrap_PaperAirplaneSimObject_paperPlane_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *arg1 = (PaperAirplaneSimObject *) 0 ;
  Airplane *arg2 = (Airplane *) 0 ;
  PyObject *swig_obj[2] ;
  
  if (!SWIG_Python_UnpackTuple(args, "PaperAirplaneSimObject_paperPlane_set", 2, 2, swig_obj)) SWIG_fail;
  {
    // PaperAirplaneSimObject *
    void * temp_ptr ;
    
    if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[0], &temp_ptr,SWIGTYPE_p_PaperAirplaneSimObject, SWIG_POINTER_DISOWN)) ) {
      arg1 = reinterpret_cast< PaperAirplaneSimObject * >(temp_ptr) ;
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[0], &temp_ptr,SWIG_TypeQuery("_p_swig_ref"), 0)) ) {
      // Array to pointer assignment
      swig_ref * temp_swig_ref = reinterpret_cast< swig_ref * >(temp_ptr);
      if ( temp_swig_ref != NULL ) {
        arg1 = reinterpret_cast< PaperAirplaneSimObject * >(temp_swig_ref->ref.address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[0], &temp_ptr,SWIG_TypeQuery("_p_REF2"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      REF2 * temp_ref = reinterpret_cast< REF2 * >(temp_ptr) ;
      if ( temp_ref != NULL ){
        arg1 = reinterpret_cast< PaperAirplaneSimObject * >(temp_ref->address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[0], &temp_ptr,SWIG_TypeQuery("_p_void"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      arg1 = reinterpret_cast< PaperAirplaneSimObject * >(temp_ptr) ;
  ...
  }
  {
    ...
    if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[1], &temp_ptr,SWIGTYPE_p_Airplane, SWIG_POINTER_DISOWN)) ) {
      arg2 = reinterpret_cast< Airplane * >(temp_ptr) ;
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[1], &temp_ptr,SWIG_TypeQuery("_p_swig_ref"), 0)) ) {
      // Array to pointer assignment
      swig_ref * temp_swig_ref = reinterpret_cast< swig_ref * >(temp_ptr);
      if ( temp_swig_ref != NULL ) {
        arg2 = reinterpret_cast< Airplane * >(temp_swig_ref->ref.address) ;
      }
    } else if ( SWIG_IsOK(SWIG_ConvertPtr(swig_obj[1], &temp_ptr,SWIG_TypeQuery("_p_REF2"), 0)) ) {
      // We have an address coming in, we don't have to do any translation
      REF2 * temp_ref = reinterpret_cast< REF2 * >(temp_ptr) ;
      if ( temp_ref != NULL ){
        arg2 = reinterpret_cast< Airplane * >(temp_ref->address) ;
      }
...
SWIGINTERN PyObject *_wrap_PaperAirplaneSimObject_paperPlane_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *arg1 = (PaperAirplaneSimObject *) 0 ;
  PyObject *swig_obj[1] ;
  Airplane *result = 0 ;
  ...
  result = (Airplane *)& ((arg1)->paperPlane);
...
SWIGINTERN PyObject *_wrap_new_PaperAirplaneSimObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "new_PaperAirplaneSimObject", 0, 0, 0)) SWIG_fail;
  result = (PaperAirplaneSimObject *)new PaperAirplaneSimObject();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_PaperAirplaneSimObject, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_PaperAirplaneSimObject_call_function(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *arg1 = (PaperAirplaneSimObject *) 0 ;
  Trick::JobData *arg2 = (Trick::JobData *) 0 ;
  void *argp2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "PaperAirplaneSimObject_call_function", 2, 2, swig_obj)) SWIG_fail;
  {
    // PaperAirplaneSimObject *
    void * temp_ptr ;
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_Trick__JobData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "PaperAirplaneSimObject_call_function" "', argument " "2"" of type '" "Trick::JobData *""'"); 
  }
  arg2 = reinterpret_cast< Trick::JobData * >(argp2);
  result = (int)(arg1)->call_function(arg2);
  {
    ...
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "PaperAirplaneSimObject_call_function" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
SWIGINTERN PyObject *_wrap_PaperAirplaneSimObject_call_function_double(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *arg1 = (PaperAirplaneSimObject *) 0 ;
  Trick::JobData *arg2 = (Trick::JobData *) 0 ;
  void *argp2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "PaperAirplaneSimObject_call_function_double", 2, 2, swig_obj)) SWIG_fail;
  {
    // PaperAirplaneSimObject *
    void * temp_ptr ;
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2,SWIGTYPE_p_Trick__JobData, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "PaperAirplaneSimObject_call_function_double" "', argument " "2"" of type '" "Trick::JobData *""'"); 
  }
  arg2 = reinterpret_cast< Trick::JobData * >(argp2);
  result = (double)(arg1)->call_function_double(arg2);
  {
    ...
    swig_double * t = new swig_double ;
    t->value = (double)result ;
    temp_name = "PaperAirplaneSimObject_call_function_double" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_double out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_double out found units " << t->units << std::endl ;
...
SWIGINTERN PyObject *_wrap_PaperAirplaneSimObject___getitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *arg1 = (PaperAirplaneSimObject *) 0 ;
  int arg2 ;
  PyObject *swig_obj[2] ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "PaperAirplaneSimObject___getitem__", 2, 2, swig_obj)) SWIG_fail;
  {
    // PaperAirplaneSimObject *
    void * temp_ptr ;
  ...
  {
    int ret ;
    ret = typemap_in_scalar<int >( arg2 , swig_obj[1] , "PaperAirplaneSimObject___getitem__") ;
    if ( ret != 0 ) {
      SWIG_exception_fail(SWIG_TypeError,"Right hand side could not be converted proper scalar type");
    }
  }
  result = (PyObject *)PaperAirplaneSimObject___getitem__(arg1,arg2);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_PaperAirplaneSimObject___len__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *arg1 = (PaperAirplaneSimObject *) 0 ;
  PyObject *swig_obj[1] ;
  PyObject *result = 0 ;
  ...
  result = (PyObject *)PaperAirplaneSimObject___len__(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_PaperAirplaneSimObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PaperAirplaneSimObject *arg1 = (PaperAirplaneSimObject *) 0 ;
  PyObject *swig_obj[1] ;
...
SWIGINTERN PyObject *PaperAirplaneSimObject_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_PaperAirplaneSimObject, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *PaperAirplaneSimObject_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
SWIGINTERN PyObject *_wrap_castAsPaperAirplaneSimObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  PyObject *arg1 = (PyObject *) 0 ;
  PyObject *swig_obj[1] ;
  PaperAirplaneSimObject *result = 0 ;
  ...
  swig_obj[0] = args;
  arg1 = swig_obj[0];
  result = (PaperAirplaneSimObject *)castAsPaperAirplaneSimObject(arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_PaperAirplaneSimObject, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "PaperAirplaneSimObject_paperPlane_set", _wrap_PaperAirplaneSimObject_paperPlane_set, METH_VARARGS, NULL},
	 { "PaperAirplaneSimObject_paperPlane_get", _wrap_PaperAirplaneSimObject_paperPlane_get, METH_O, NULL},
	 { "new_PaperAirplaneSimObject", _wrap_new_PaperAirplaneSimObject, METH_NOARGS, NULL},
	 { "PaperAirplaneSimObject_call_function", _wrap_PaperAirplaneSimObject_call_function, METH_VARARGS, NULL},
	 { "PaperAirplaneSimObject_call_function_double", _wrap_PaperAirplaneSimObject_call_function_double, METH_VARARGS, NULL},
	 { "PaperAirplaneSimObject___getitem__", _wrap_PaperAirplaneSimObject___getitem__, METH_VARARGS, NULL},
	 { "PaperAirplaneSimObject___len__", _wrap_PaperAirplaneSimObject___len__, METH_O, NULL},
	 { "delete_PaperAirplaneSimObject", _wrap_delete_PaperAirplaneSimObject, METH_O, NULL},
	 { "PaperAirplaneSimObject_swigregister", PaperAirplaneSimObject_swigregister, METH_O, NULL},
	 { "PaperAirplaneSimObject_swiginit", PaperAirplaneSimObject_swiginit, METH_VARARGS, NULL},
	 ...
	 { "castAsPaperAirplaneSimObject", _wrap_castAsPaperAirplaneSimObject, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static void *_p_PaperAirplaneSimObjectTo_p_Trick__SimObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Trick::SimObject *)  ((PaperAirplaneSimObject *) x));
}
